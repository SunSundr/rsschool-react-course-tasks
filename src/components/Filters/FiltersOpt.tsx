...
export const Filters = memo(function FiltersOpt() {
  ...
  const handleChange = useCallback(
    (e: React.ChangeEvent<HTMLSelectElement | HTMLInputElement>, type: FilterChangeType) => {
    ...
    [filters.selectedYear, filters.selectedRegion, filters.countrySearch],
  );
  ...
  }, [localSelectedColumns, isUpdatingColumns]);
